...
net.Receive("gms_MakeProcessBar", function()
	CurrentProcess = net.ReadString()
	ProcessStart = CurTime()
	ProcessCompleteTime = net.ReadInt(32)
	ProcessCancelAble = net.ReadBool()
end)

net.Receive("gms_ResetPlayer", function()
	Tribes = {}
	Skills = {}
	Skills["Survival"] = 0
	Resources = {}
...
net.Receive("gms_StopProcessBar", function()
	ProcessCompleteTime = false
end)

net.Receive("gms_MakeLoadingBar", function()
	GAMEMODE.LoadingBar:Show(net.ReadString())
end)

net.Receive("gms_StopLoadingBar", function()
	GAMEMODE.LoadingBar:Hide()
end)

net.Receive("gms_MakeSavingBar", function()
	GAMEMODE.SavingBar:Show(net.ReadString())
end)

net.Receive("gms_StopSavingBar", function()
	GAMEMODE.SavingBar:Hide()
end)

net.Receive("gms_SetSkill", function()
	Skills[net.ReadString()] = net.ReadInt(32)
	MaxResources = 25 + (GetSkill("Survival") * 5)
	GAMEMODE.SkillsHud:RefreshSkills()
end)

net.Receive("gms_SetXP", function()
	Experience[net.ReadString()] = net.ReadInt(32)
end)

net.Receive("gms_SetResource", function()
...
net.Receive("gms_SetMaxResources", function()
	MaxResources = net.ReadInt(32)
	GAMEMODE.ResourcesHud:RefreshResources()
end)

net.Receive("gms_OpenCombiMenu", function()
	if (GAMEMODE.CombiMenu) then GAMEMODE.CombiMenu:Remove() end
	GAMEMODE.CombiMenu = vgui.Create("GMS_CombinationWindow")
	GAMEMODE.CombiMenu:SetTable(net.ReadString())
end)
...
net.Receive("gms_sendmessage", function()
...
net.Receive("gms_CreateFadingProp", function()
...
net.Receive("gms_sendachievement", function()
	local tbl = {}
...
net.Receive("gms_setneeds", function()
	Sleepiness = net.ReadInt(32)
	Hunger = net.ReadInt(32)
	Thirst = net.ReadInt(32)
	Oxygen = net.ReadInt(32)
	Power = net.ReadInt(32)
	Time = net.ReadInt(32)
end)
...
net.Receive("gms_invite", function()
...
net.Receive("sendTribe", function()

	local id = net.ReadInt(32)
	local name = net.ReadString()
	local color = net.ReadVector()
	local hazpass = net.ReadBool()
